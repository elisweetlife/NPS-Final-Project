...
// Defining a markerSize function that will give each city a different radius based on its qty of campsites
function markerSize(campsites) {
  return campsites / 0.003;
}

// Each city object contains the city represents an NPS Including city name, coordinates, and qty of campsites.
var cities = [
{
  parkcode:"AIP",
