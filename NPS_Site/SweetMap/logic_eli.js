...
/* Eli Starting - Looping through the cities array and creating one marker for each city object (Eli)
for (var i = 0; i < cities.length; i++) {
  ...
  //}).bindPopup("<h1>" + cities[i].name + "</h1> <hr> <h3>campsites = " + cities[i].campsites + "</h3>").addTo(myMap); Try to add another line
...
// Looping through the cities array and creating one marker for each city object (Kenny)
var circles = [];
for (var i = 0; i < cities.length; i++) {
